import { createContext, useReducer, useCallback, useContext, ChangeEvent, ReactElement } from "react";
...
const reducer = (state: StateTypes, action: ReducerAction): StateTypes => {
    switch (action.type) {
        ...
        case REDUCER_ACTION_TYPE.NEW_INPUT:
            // get a TS warning if we don't add the nullish coalescing operator
            // because the payload is optional and can be undefined
...
const useCounterContext = (initState: StateTypes) => {
...
const initContextState: UseCounterContextType = {
    ...
    increment: () => {},
    decrement: () => {},
    handleTextInput: (e: ChangeEvent<HTMLInputElement>) => {e},
}
...
export const CounterProvider = ({children, ...initState}: ChildrenType & StateTypes): ReactElement => {
    return (
